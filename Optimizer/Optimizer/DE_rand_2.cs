...
namespace OptimizerSet
{
    public class DE_rand_2
    {
        ...
        private int Mutation_Sel = 3; // DE变异算子选择，DE/rand/1，DE/best/1，DE/rand/2，DE/best/2
        ...
        private void Opt()
        {
            ...
            while (FEs < Max_FEs)
            {
                ...
                //    break;
                //}
                Console.WriteLine("DE_rand_2 " + FEs + " " + Best_Fun.ToString("f2") + " " + Best_Delta.ToString("f2"));
            }
        }
