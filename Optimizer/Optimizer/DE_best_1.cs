...
namespace OptimizerSet
{
    public class DE_best_1
    {
        ...
        private int Mutation_Sel = 2; // DE变异算子选择，DE/rand/1，DE/best/1，DE/rand/2，DE/best/2
        ...
        private void Opt()
        {
            ...
            while (FEs < Max_FEs)
            {
                ...
                //    break;
                //}
                Console.WriteLine("DE_best_1 " + FEs + " " + Best_Fun.ToString("f2") + " " + Best_Delta.ToString("f2"));
            }
        }
